...
$sql = "SELECT tblclass.ID as classID, tblclass.ClassName, tblclass.Section, tblnotice.NoticeTitle, tblnotice.CreationDate, tblnotice.ClassId, tblnotice.ID as nid 
        FROM tblnotice 
                          ...
                          <tr>
                            ...
                            <td>
                              <div><a href="edit-notice-detail.php?editid=<?php echo htmlentities ($row->ID);?>"><i class="icon-eye"></i></a>
                                                || <a href="manage-notice.php?delid=<?php echo ($row->nid);?>" onclick="return confirm('Do you really want to Delete ?');"> <i class="icon-trash"></i></a>
